...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    private List<OnSwipeBackListener> mListeners;
     ...
     */
    @Deprecated
    public void setSwipeListener(OnSwipeBackListener listener) {
     ...
     * @param listener the swipe listener to attach to this view
     */
    public void addSwipeListener(OnSwipeBackListener listener) {
        if (mListeners == null) {
            mListeners = new ArrayList<OnSwipeBackListener>();
        }
     ...
     * @param listener
     */
    public void removeSwipeListener(OnSwipeBackListener listener) {
        if (mListeners == null) {
            return;
        }
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (ret) {
                if (mListeners != null && !mListeners.isEmpty()) {
                    for (OnSwipeBackListener listener : mListeners) {
