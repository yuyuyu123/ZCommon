...
import com.cc.android.zcommon.support.LceAnimatorHelper;
...
public abstract class RxLceFragment<CV extends View, M, V extends RxLceView<M>, P extends RxBasePresenter<V>>
    ...
    protected void init(Bundle savedInstanceState, View view) {
        ...
        contentView = getParentView().findViewById(R.id.contentView);
        errorView = getParentView().findViewById(R.id.errorView);
